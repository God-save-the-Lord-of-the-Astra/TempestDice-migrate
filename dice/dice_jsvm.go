...
func (d *Dice) JsInit() {
	...
	loop.Run(func(vm *goja.Runtime) {
		...
		_ = seal.Set("memberUnban", MemberUnban)
		_ = seal.Set("memberWholeBan", MemberWholeBan)
		_ = seal.Set("memberKick", MemberKick)
		_ = seal.Set("EditMessage", EditMessage)
		_ = seal.Set("RecallMessage", RecallMessage)
		_ = seal.Set("SendToGroupNotice", SendToGroupNotice)
